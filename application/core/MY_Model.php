...
class MY_Model extends CI_Model
{
    ...
    public function relate($row)
    {
        foreach ($this->belongs_to as $key => $value)
        {
            ...
            {
                $relationship = $value;
                $options = array( 'primary_key' => $value . '_id', 'model' => $value . '_model','model_route' => $value );
            }
            else
            {
                $relationship = $key;
            ...
            {
                $this->load->model($options['model_route']);
                if (is_object($row))
                {
    ...
    function dropdown()
    {
        ...
        $options = array('none" selected="selected" disabled="disabled"'=> $this->lang->line('pa_select'));
