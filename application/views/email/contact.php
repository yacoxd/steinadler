					...
					<table table border="0" cellpadding="0" cellspacing="0" width="650" style="background-color: #fff; border: 0; padding-top: 20px;">
						...
						<tr>
							<td valign="top" style="padding-right: 0; padding-left: 50px; padding-top: 30px; padding-bottom: 30px; margin: 0;">
								<table width="250px">
									<tr>
										<td valign="center" width="90px" style="text-align: left; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px; width: 90px;">Company:</td>
										<td valign="center" style="text-align: left; font-family: 'Times New Roman', Times, Georgia, serif; font-size: 18px; font-weight: bold; line-height: 18px;"><?php echo @$company?></td>
									</tr>
									<tr>
										<td valign="center" width="90px" style="text-align: left; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px; width: 90px;">Country:</td>
										<td valign="center" style="text-align: left; font-family: 'Times New Roman', Times, Georgia, serif; font-size: 18px; font-weight: bold; line-height: 18px;"><?php echo @$country ?></td>
									</tr>
									<tr>
										<td valign="center" width="90px" style="text-align: left; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px; width: 90px;">Email:</td>
									...
									<tr>
										<td valign="center" width="90px" style="text-align: left; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px; width: 90px;">Message:</td>
										<td valign="center" style="text-align: left; font-family: 'Times New Roman', Times, Georgia, serif; font-size: 18px; font-weight: bold; line-height: 18px;"><?php echo @$message ?></td>
									</tr>
								</table>
							</td>
						</tr>
